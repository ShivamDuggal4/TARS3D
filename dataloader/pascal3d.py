...
class Dataset(base.Dataset):
    ...
    def __init__(self, opt, split="train", subset=None):
        ...
        self.path = os.path.join(opt.data.dataset_root_path, "PASCAL3D+_release1.1")
        self.path_mask = os.path.join(opt.data.dataset_root_path, "pascal3d/mask/{}".format(self.cat))
        self.path_pc = os.path.join(opt.data.dataset_root_path, "pascal3d/pointcloud/{}".format(self.cat))
    ...
    def get_list(self, opt, split):
        list_fname = "data_splits/pascal3d_imagenet_{}_{}.list".format(self.cat, split)
